...
var _Video = _interopRequireDefault(__webpack_require__(2));

var _WishTree = _interopRequireDefault(__webpack_require__(3));
...
var showVideo = new _Video.default();
var wishTree = new _WishTree.default();
...
function () {
  function WishTree() {
    _classCallCheck(this, WishTree);

    this.events();
  }

  _createClass(WishTree, [{
    key: "events",
    value: function events() {
      (0, _jquery.default)(".submit-note").on("click", this.createWish.bind(this));
    } // Methods will go here

  }, {
    key: "createWish",
    value: function createWish(e) {
      var ourNewPost = {
      ...
      if ((0, _jquery.default)(".new-note-title").val() == '' || (0, _jquery.default)(".new-note-body").val() == '') {
        ...
        _jquery.default.ajax({
          ...
          success: function success(response) {
            (0, _jquery.default)("#img-tree").attr("src", strokeknowhowData.stylesheet_directory_uri + "/images/Wish–Tree_May.gif");
